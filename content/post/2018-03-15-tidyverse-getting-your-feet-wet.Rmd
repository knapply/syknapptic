...
```{r echo=FALSE}
include_graphics("workflow_2.png")
```
...
```{r echo=FALSE}
include_graphics("tidyverse_expanded.png")
```
...
```{r echo=FALSE}
include_graphics("data_carpentry.png")
```
...
```{r echo=FALSE}
include_graphics("ggplot_cheat_sheet.png")
```
...
```{r echo=FALSE}
include_graphics("r_graph_catalog.png")
```
...
```{r echo=FALSE}
include_graphics("tidy_data.png")
```

```{r echo=FALSE}
include_graphics("tidy_data_2.png")
```

```{r echo=FALSE}
include_graphics("messy_tidy.png")
```
...
```{r echo=FALSE}
include_graphics("ggplot_exercise_1.png")
```
...
```{r echo=FALSE}
include_graphics("summarize.png")
```
...
```{r echo=FALSE}
include_graphics("ggplot_layers_all.png")
```
