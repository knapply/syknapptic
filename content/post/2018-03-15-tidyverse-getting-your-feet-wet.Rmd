...
<!-- ![](http://res.cloudinary.com/syknapptic/image/upload/v1521305505/r_memes_stats_fiends_pndvt3.jpg) -->

<img src="http://res.cloudinary.com/syknapptic/image/upload/v1521305505/r_memes_stats_fiends_pndvt3.jpg" alt="tidyverse!" class="center">
...
Here is the workflow I used for the first session. The goal was to introduce the primary `{dplyr}` verbs, functions that accomplish tasks neccesary in nearly every project. Between each of these sections is an exercise using `{ggplot}`. 
...
`tibble`s are opinionated `data.frame`s that keep everything that is helpful about `data.frame`s, changes some of their quirks, and adds methods that makes thems even more useful.
